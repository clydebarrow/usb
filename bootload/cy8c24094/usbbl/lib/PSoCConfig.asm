...
export LoadConfig_usbbl
export _LoadConfig_usbbl
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_usbbl_Ordered
	lcall	LoadConfig_usbbl
...
;---------------------------------------------------------------------------
; Load Configuration usbbl
;
;    Load configuration registers for usbbl.
...
_LoadConfig_usbbl:
 LoadConfig_usbbl:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_usbbl_Bank0
    mov     X, <LoadConfigTBL_usbbl_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_usbbl_Bank1
    mov     X, <LoadConfigTBL_usbbl_Bank1

...
{
	((unsigned char  *)&RES.value)[0] = val;
	((unsigned char  *)&RES.value)[1] = val >> 8;
	((unsigned char  *)&RES.value)[2] = 0;
	((unsigned char  *)&RES.value)[3] = 0;
}
...
Endpoint_1(void)
{
	...
	USB_read_packet(EP_OUT_INDEX, ( unsigned char *)&CMD, sizeof CMD);

...
typedef struct
{
	...
	unsigned char	pad;			// dummies to pad it out
}	BCMD;
...
#define	BL_VERIFY	0x05
#define	BL_INIT		0x06

// sense codes

#define	BL_BADREQ	0x01			// unknown request
#define	BL_PROGFAIL	0x02			// programming failure
#define BL_VERIFYERR 0x03
#define BL_NOINIT	0x04
...
volatile __ioport unsigned char	EP0DR[8] @	0x058;	// EP0 Data Register array
...
extern unsigned char 	USB_status[NUM_ENDPOINTS];
...
extern reentrant unsigned short USB_read_packet(unsigned char index, unsigned char  * ptr, unsigned short cnt);

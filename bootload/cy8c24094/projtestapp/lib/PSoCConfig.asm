...
export LoadConfig_userapp
export _LoadConfig_userapp
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_userapp_Ordered
	lcall	LoadConfig_userapp
...
;---------------------------------------------------------------------------
; Load Configuration userapp
;
;    Load configuration registers for userapp.
...
_LoadConfig_userapp:
 LoadConfig_userapp:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_userapp_Bank0
    mov     X, <LoadConfigTBL_userapp_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_userapp_Bank1
    mov     X, <LoadConfigTBL_userapp_Bank1

...
#define PORT_7_DRIVE_1         0xff    //Port 2 drive mode 1 register (PRT7DM1)
#define PORT_7_DRIVE_2         0xff    //Port 2 drive mode 2 register (PRT7DM2)

...
export LoadConfigTBL_userapp_Bank1
export LoadConfigTBL_userapp_Bank0
export LoadConfigTBL_userapp_Ordered
AREA lit(rom, rel)
LoadConfigTBL_userapp_Ordered:
;  Ordered Global Register values
	...
	mov	reg[1dh], ffh		; Port_7_DriveMode_1 register (PRT7DM1)
	M8C_SetBank0
	mov	reg[1fh], ffh		; Port_7_DriveMode_2 register (PRT7DM2)
...
;  Global Register values
	...
	db		fdh, 00h		; DAC_Data register (DAC_D)

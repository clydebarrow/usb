...
static USB_CONST unsigned char * USB_CONST	psoctest_configurations[] =
{
	psoctest_data+18,
};

static USB_CONST unsigned short psoctest_conf_sizes[] =
{
	32,
};

static USB_CONST unsigned char * USB_CONST	psoctest_strings[] =
{
	psoctest_data+50,
	psoctest_data+54,
	psoctest_data+88,
...
USB_CONST USB_descriptor_table	psoctest_table =
{
	psoctest_data,
	psoctest_configurations,
	psoctest_strings,
	psoctest_conf_sizes,	1, 6,
};

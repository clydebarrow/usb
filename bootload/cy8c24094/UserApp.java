...
public class UserApp extends Frame implements ActionListener
{
...
/* Bootloader stuff */
	...
	private static final String	BL_VIDPID 	= "0x1725:0x0003";
	...
	private static final int	BL_REQBL	= 	0x0E;
...
/* JTAG programming stuff */
	...
	private Button  ProgramButton = new Button("Send Command");	
	...
	public void actionPerformed(ActionEvent e){
		...
		if(command.equals("Send Command")){
 ...
 */
	...
	boolean testDevice() throws IOException
	{
		...
		r = transact(BL_REQBL, 0, null, 0, 0);
